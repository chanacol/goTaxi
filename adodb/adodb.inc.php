...
define('_ADODB_LAYER',1);
	...
	*/
	...
	CFRO se creo esta funcion para que  reemplace caracteres en lugar de escapar caracteres

	el caracter ' en lugar de escapar por \'' lo remplace por ''
	...
	*/
...

	{
		...
		return str_replace('\"','"', str_replace("\''","''", $this->qstr($s,false)) );
	...
	CFRO se creo esta funcion para regresar la función adecuada para manejo del año en los campos fecha   

	*/

	function miDBFunctionYear($nomCampoFecha)

	{

		if ( trim($this->databaseType) == 'mssql' )

			return "DATEPART(YY, $nomCampoFecha)";	

		else if ( trim($this->databaseType) == 'oracle' )										

			return "to_char($nomCampoFecha, 'yyyy')";
	...
	CFRO se creo esta funcion para regresar la función adecuada para manejo del MES en los campos fecha   

	*/

	function miDBFunctionMonth($nomCampoFecha)

	{

		if ( trim($this->databaseType) == 'mssql' )

			return "DATEPART(MM, $nomCampoFecha)";	

		else if ( trim($this->databaseType) == 'oracle' )										

			return "to_char($nomCampoFecha, 'MM')";
	...
	CFRO se creo esta funcion para regresar la función adecuada para manejo del DIA en los campos fecha   

	*/

	function miDBFunctionDay($nomCampoFecha)

	{

		if ( trim($this->databaseType) == 'mssql' )

			return "DATEPART(DD, $nomCampoFecha)";	

		else if ( trim($this->databaseType) == 'oracle' )										

			return "to_char($nomCampoFecha, 'DD')";
	...
	CFRO se creo esta funcion para regresar la función adecuada de SQL para obtener la fecha del sistema  

	*/

	function miDBFunctionSQLDate()
