...
if (PHP_VERSION < 5) include_once('../../components/adodb/adodb-pear.inc.php');
//--------------------------------------------------------------------------------------
...
global $ADODB_EXTENSION;
	...
	include_once('../../components/adodb/session/adodb-session.php');
...
*/
 ...
 //	$db->debug=true;
	...
	print "<p>Test CSV</p>";
	include_once('../../components/adodb/toexport.inc.php');
	//$ADODB_FETCH_MODE = ADODB_FETCH_ASSOC;
	...
	/////////////////////////////////////////////////////////////
	include_once('../../components/adodb/pivottable.inc.php');
	...
	include_once "../../components/adodb/tests/PEAR.php";
...
include("../../components/adodb/tohtml.inc.php");
include("../../components/adodb/adodb.inc.php");
include("../../components/adodb/rsfilter.inc.php");
...
Test <a href=../../components/adodb/tests/test4.php>GetInsertSQL/GetUpdateSQL</a> &nbsp; 
	<a href=../../components/adodb/tests/testsessions.php>Sessions</a> &nbsp;
	<a href=../../components/adodb/tests/testpaging.php>Paging</a> &nbsp;
	<a href=../../components/adodb/tests/test-perf.php>Perf Monitor</a><p>
<?php
include('../../components/adodb/tests/testdatabases.inc.php');

echo "<br>vers=",ADOConnection::Version();


include_once('../../components/adodb/adodb-time.inc.php');
