...
function tpear()
{
include_once('../../components/adodb/tests/DB.php');
...
function tadodb()
{
include_once('../../components/adodb/adodb.inc.php');
...
?>
<a href=../../components/adodb/tests/tmssql.php?do=tmssql>mssql</a>
<a href=../../components/adodb/tests/tmssql.php?do=tpear>pear</a>
<a href=../../components/adodb/tests/tmssql.php?do=tadodb>adodb</a>
<?php
if (!empty($_GET['do'])) {
	$do = $_GET['do'];
	switch($do) {
