...
include("../../components/adodb/tests/adodb-exceptions.inc.php");
include("../../components/adodb/tests/adodb.inc.php");	
...
try {
	include_once("../../components/adodb/adodb-active-record.inc.php");
...
include_once("../../components/adodb/tests/test-active-record.php");
?>