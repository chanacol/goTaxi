...
wrapper library.
 ...
 =======
	...
	include('../../../components/adodb/session/old/adodb.inc.php');
	#---------------------------------#
	include('../../../components/adodb/session/old/adodb-cryptsession.php'); 
	#---------------------------------#
	session_start();
...
include_once('../../../components/adodb/session/old/crypt.inc.php');
